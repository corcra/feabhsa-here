...
plot_metaplot<-function(dl,dataname){
    ...
    ggsave(paste0(dataname,".pdf"),width=10)
}
...
if(!preprocess){
    ...
    cat("H3K27ac!\n")
    H3K27ac<-load.bigWig('/Users/stephanie/ll/data/ChIPseq/bw/H3K27Ac.sorted.bw')
    ...
    H3K427ac_data$region_name<-factor(H3K427ac_data$region_name,c("gene_start","gene_body","non_gene"))
